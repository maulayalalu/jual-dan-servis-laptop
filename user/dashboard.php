...
<div style="min-height:100vh;background:var(--color-cream);padding-top:72px;">
  ...
  <!-- Welcome Banner -->
  <div style="background:linear-gradient(135deg,var(--color-navy) 0%,var(--color-navy-dark) 100%);padding:32px 0;margin-bottom:0;">
    <div class="container" style="max-width:1100px;">
      <div style="display:flex;align-items:center;gap:20px;flex-wrap:wrap;">
        <div style="width:60px;height:60px;border-radius:50%;background:var(--color-taupe);color:white;display:grid;place-items:center;font-size:24px;font-weight:700;flex-shrink:0;border:3px solid rgba(255,255,255,0.20);box-shadow:0 4px 16px rgba(0,0,0,0.18);">
  ...
  <div class="container" style="max-width:1100px;padding-top:32px;padding-bottom:80px;">
    ...
    <div class="stat-grid" style="margin-bottom:28px;">
      ...
      <div class="stat-card">
        ...
        <div class="stat-card__label">Akun Saya</div>
        <div class="stat-card__value" style="font-size:15px;line-height:1.3;"><?= htmlspecialchars($_SESSION['nama']) ?></div>
        <div class="stat-card__change" style="font-size:11px;"><?= htmlspecialchars($profil['email']) ?></div>
      </div>
    </div>
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:20px;margin-bottom:20px;">
      ...
      <div class="table-wrap">
        ...
        <table>
          ...
          <?php endwhile; else: ?>
          <tr><td colspan="4"><div class="empty-state" style="padding:24px;"><p>Belum ada pesanan. <a href="katalog.php" style="color:var(--color-navy);font-weight:600;">Belanja sekarang!</a></p></div></td></tr>
          <?php endif; ?>
          </tbody>
        </table>
      </div>
      ...
      <div class="table-wrap">
        ...
        <table>
          ...
          <tr>
            <td>
              <div style="font-weight:600;font-size:13px;color:var(--color-carbon);"><?= htmlspecialchars($s['tipe_laptop']) ?></div>
          ...
          <?php endwhile; else: ?>
          <tr><td colspan="4"><div class="empty-state" style="padding:24px;"><p>Belum ada servis. <a href="request_servis.php" style="color:var(--color-navy);font-weight:600;">Ajukan sekarang!</a></p></div></td></tr>
          <?php endif; ?>
          </tbody>
        </table>
      </div>
    ...
    <div class="settings-panel">
      <div class="settings-panel__header">
        ...
        <div>
          <div class="settings-panel__title">Informasi Profil</div>
          <div class="settings-panel__sub">Detail akun Anda</div>
        </div>
        <a href="profil.php" class="btn btn--secondary btn--sm" style="margin-left:auto;" id="btnEditProfil">Edit Profil</a>
      </div>
