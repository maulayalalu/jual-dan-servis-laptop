    ...
    if ($action === 'simpan') {
        ...
        if (isset($_FILES['gambar_baru']) && $_FILES['gambar_baru']['error'] !== UPLOAD_ERR_NO_FILE) {
            if ($_FILES['gambar_baru']['error'] === UPLOAD_ERR_INI_SIZE || $_FILES['gambar_baru']['size'] > 10 * 1024 * 1024) {
                ...
                redirect('kelola_hero.php' . ($id ? "?edit=$id" : ""));
                exit;
        ...
        if ($id === 0) {
            ...
            redirect('kelola_hero.php?edit=' . $newId);
            exit;
        } else {
            ...
            redirect('kelola_hero.php?edit=' . $id);
            exit;
        }
    }
      ...
      <div class="slide-history">
        ...
        ?>
          <div style="display:flex; flex-direction:column; gap:8px;">
            <div class="slide-thumb <?= $isActive ? 'active' : '' ?>" onclick="window.location.href='kelola_hero.php?edit=<?= $s['id_slide'] ?>'">
